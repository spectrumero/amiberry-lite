...
void InitPanelChipset(const struct config_category& category)
{
	...
	optBlitNormal->setBackgroundColor(gui_background_color);
	...
	optBlitImmed->setBackgroundColor(gui_background_color);
	...
	optBlitWait->setBackgroundColor(gui_background_color);
	...
	chkFastCopper->setBackgroundColor(gui_background_color);
